$(document).ready(function(){
	...
	$("#main.image-preloader figure > img, #main.image-preloader figure.figure-overlay img, #main.image-preloader figure.figure-hover img, #main.image-preloader p img, #main.image-preloader div > a > img").lazyload({
		placeholder: "http://localhost/budaya/assets/frontend/images/grey.gif",
		effect: "fadeIn"
	});
	...
	$("#customize .colors a").click(function(e) {
		...
		$('head').append('<link rel="stylesheet" type="text/css" href="http://localhost/budaya/assets/frontend/css/customizer/'+ $color +'.css">');
		$('#header .logo img').attr('src', 'http://localhost/budaya/assets/frontend/css/customizer/images/' + $color + '/logo.png');
		e.preventDefault();
	});
	
	$("#customize .background a").click(function(e) {
		var $number = $(this).attr('class');
		$("body").css('background', 'url(http://localhost/budaya/assets/frontend/images/pattern/' + $number + '.jpg) repeat');
		e.preventDefault();
	});
	/* End customizer */
