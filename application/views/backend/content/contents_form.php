<form class="form-horizontal" role="form" action="<?php echo $action; ?>" name="contents" id="contents" method="POST" enctype="multipart/form-data">
	...
	<div class="form-group">
		<label class="col-sm-3 control-label no-padding-right" for="form-field-1-1"> Type Contents </label>
		<div class="col-sm-9">
	...
	<div class="form-group">
		<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Media Path (300*300) </label>
		<div class="col-sm-9">
			<?php echo form_error('path2') ?>
			<div class="input-group">
				<span class="input-group-btn">
						<button type="button" class="btn btn-purple btn-sm">
							<span class="ace-icon fa fa-search icon-on-right bigger-110"></span>
							<a href="<?=site_url('assets/filemanager/dialog.php?type=1&amp;field_id=fieldID2');?>" class="iframe-btn">Select</a>
						</button>
					</span>
				<input class="col-xs-10 col-sm-10" id="fieldID2" type="text" name="path2" value="<?php echo $path2; ?>" />					
			</div>
		</div>
	</div>
	...
	<div class="clearfix form-actions">
		<div class="col-md-offset-3 col-md-9">
			...
			&nbsp; &nbsp; &nbsp;
			<a href="<?php echo site_url('contents') ?>" class="btn btn-warning">Cancel</a>
		</div>
	</div>
