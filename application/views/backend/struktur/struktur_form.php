<form class="form-horizontal" role="form" action="<?php echo $action; ?>" name="users" id="users" method="POST" enctype="multipart/form-data">
	...
	<div class="form-group">
		<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Struktur Name </label>
		<div class="col-sm-9">
	...
	<div class="form-group">
		<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Struktur Path  </label>
		<div class="col-sm-9">
	...
	<div class="clearfix form-actions">
		<div class="col-md-offset-3 col-md-9">
			...
			&nbsp; &nbsp; &nbsp;
			<a href="<?php echo site_url('slider') ?>" class="btn btn-warning">Cancel</a>
		</div>
	</div>
