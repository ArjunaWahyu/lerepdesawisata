...
class struktur_ppid extends CI_Controller {
        public function __construct() {
            ...
            $this->load->model('struktur_ppid_model');
        ...
        public function index()
         ...
         public function page($offset=0, $year = null, $month = null, $day = null){
            ...
            $row = $this->struktur_ppid_model->get_by_id('1');            

            // $jml = $this->struktur_ppid_model->get_by_all_type('Y', 2);
            
            $config['base_url'] = base_url().'struktur_ppid/page/';
            ...
            // $data['data'] = $this->struktur_ppid_model->get_by_list('Y',$config['per_page'], $offset, '2');
            ...
            $this->load->view('frontend/strukturorganisasi_ppid',$data);

        }

        public function read($url=null, $year = null, $month = null, $day = null){
            $row                = $this->struktur_ppid_model->get_by_url($url);
            $contents           = $this->struktur_ppid_model->get_by_related('Y',4,0,$row->type);
            $setting = $this->setting_model->get_by_published('Y');
            ...
            $update = array(
                 ...
                 $this->struktur_ppid_model->update($row->id, $update);
