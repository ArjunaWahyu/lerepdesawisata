  ...
  <br/>
    ...
    <div class="panel panel-body">
        ...
        <form id='telegramForm' method='POST'>
          <input type='hidden' class='form-control' name='chat_id' id='telegram_id' value='319835889'> 
        ...
        swal({
          ...
          preConfirm: function() {
            return new Promise(function(resolve) {
              $.ajax({
                url: 'https://api.telegram.org/bot1454739382:AAEO_REou9tq_DSTfKzyMuH3IJl8Rm5d_e0/sendMessage?parse_mode=Markdown',
                  type: 'POST',
