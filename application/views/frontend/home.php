  ...
  <div class="headlines clearfix">
   ...
   <div class="text-rotator">
    <div><a href="" title="View permalink Small Market and St. Sebastian's Square in Opole">Selamat Datang di Desa Wisata Lerep</a></div>
    <div><a href="" title="View permalink Small Market and St. Sebastian's Square in Opole">Selamat Datang di Desa Wisata Lerep</a></div>
    </div>
  </div> <!-- End Headlines -->
  ...
  <div class="row-fluid">
   <div id="main" class="span8 image-preloader">
    ...
    <?php
      ...
      $m=array('1'=>'Pariwisata','2'=>'Budaya','3'=>'Pemerintahan' );
      $i=0;                
      foreach ($contents as $key) {
        ...
        echo '<div class="span6 post no-margin-left">
            ...
            <div class="text">
             ...
             <p>'.character_limiter($key->dest, 0).''.anchor('read/'.$key->url.'', 'read more', 'title="read more"').'</p>
