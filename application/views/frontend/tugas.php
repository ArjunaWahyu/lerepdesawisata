...
class tugas extends CI_Controller {
        ...
        public function index()
         ...
         public function page($offset=0, $year = null, $month = null, $day = null){
            ...
            $row = $this->tugas_ppid_model->get_by_name('1');            

            $jml = $this->tugas_ppid_model->get_by_all_type('Y', 2);
            
            $config['base_url'] = base_url().'tugas_ppid/page/';
            ...
            // $data['data'] = $this->tugas_ppid_model->get_by_list('Y',$config['per_page'], $offset, '2');
            ...
            $this->load->view('frontend/tugas_ppid',$data);

        }

        public function read($url=null, $year = null, $month = null, $day = null){
            $row                = $this->tugas_ppid_model->get_by_url($url);
            $contents           = $this->tugas_ppid_model->get_by_related('Y',4,0,$row->type);
            $setting = $this->setting_model->get_by_published('Y');
            ...
            $update = array(
                 ...
                 $this->tugas_ppid_model->update($row->id, $update);
