   ...
   <div id="main" class="span8 blog-photos image-preloader">
    ...
    <div class="row-fluid">
     ...
     <div class="breadcrumb clearfix">
      ...
      <p><a href="index-2.html">Home</a>&nbsp;&nbsp;&rarr;&nbsp;&nbsp;Archive Category: <a href="<?php echo $urls; ?>" title="View articles in homestay Wisata Posts">homestay Wisata Posts</a></p>
     </div> <!-- End Breadcrumb -->
     ...
     foreach ($dataq as $key) {
           ...
           if($i==1){
            ...
            <figure class="figure-overlay">
             <a href="'.base_url('homestay/read/'.$key->url).'">
              <img src="'.$key->path.'" alt="Thumbnail" />
              <div><p>'.$key->name.' <i>by '.$key->fullname.'</i></p></div>
             </a>
            </figure>
            <div class="text">
             <h2>'.anchor('homestay/read/'.$key->url.'', ''.$key->name.'', 'title="'.$key->name.'"').'</h2>
