...
class peraturandesab_model extends CI_Model
{

    public $table = 'peraturan_desa';
    public $id = 'id';
    public $url = 'url';
    ...
    function get_by_all_id($published, $id=null)
    {
        ...
        // $this->db->where('id', $id);
        // $this->db->join('useradmin', 'peraturan.userid = useradmin.id');
    ...
    function get_by_url($id)
    {
        ...
        $this->db->select('peraturan_desa.id,
                            peraturan_desa.name,
                            peraturan_desa.dest,
                            peraturan_desa.id,
                            peraturan_desa.published,
                      
                       
                            peraturan_desa.metatittle,
                            peraturan_desa.metadest,
                            peraturan_desa.metakey,
                            peraturan_desa.create_at,
                            peraturan_desa.update_at,');
        $this->db->where($this->id, $id);
    ...
    //     return $this->db->get($this->table)->result();
    // }
     function get_by_published($published)
    {
        $this->db->where($this->published, $published);
        return $this->db->get($this->table)->row();
    }
...
/* End of file peraturan_model.php */
/* Location: ./application/models/peraturan_model.php */