...
class Visimisi_model extends CI_Model
{
    ...
    function get_by_all_id($published, $id=null)
    {
        ...
        // $this->db->where('id', $id);
        // $this->db->join('useradmin', 'visimisi.userid = useradmin.id');
...
/* End of file visimisi_model.php */
/* Location: ./application/models/visimisi_model.php */