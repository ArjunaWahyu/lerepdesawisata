...
class maklumat_ppid_model extends CI_Model
{

    public $table = 'maklumat';
    public $id = 'id';
    public $url = 'url';
    ...
    function get_by_all_id($published, $id=null)
    {
        ...
        // $this->db->where('id', $id);
        // $this->db->join('useradmin', 'maklumat.userid = useradmin.id');
...
/* End of file maklumat_ppid_model.php */
/* Location: ./application/models/maklumat_ppid_model.php */