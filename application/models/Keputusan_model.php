...
class Keputusan_model extends CI_Model
{
    ...
    function get_by_all_id($published, $id=null)
    {
        ...
        // $this->db->where('id', $id);
        // $this->db->join('useradmin', 'keputusan.userid = useradmin.id');
...
/* End of file keputusan_model.php */
/* Location: ./application/models/keputusan_model.php */