...
class tugas_ppid_model extends CI_Model
{

    public $table = 'tugas_ppid';
    public $id = 'id';
    public $url = 'url';
    ...
    function get_by_all_id($published, $id=null)
    {
        ...
        // $this->db->where('id', $id);
        // $this->db->join('useradmin', 'tugas_ppid.userid = useradmin.id');
    ...
    function get_by_url($id)
    {
        ...
        $this->db->select('tugas_ppid.id,
                            tugas_ppid.name,
                            tugas_ppid.dest,
                            tugas_ppid.id,
                            tugas_ppid.published,
                      
                       
                            tugas_ppid.metatittle,
                            tugas_ppid.metadest,
                            tugas_ppid.metakey,
                            tugas_ppid.create_at,
                            tugas_ppid.update_at,');
        $this->db->where($this->id, $id);
...
/* End of file tugas_ppid_ppid_model.php */
/* Location: ./application/models/tugas_ppid_ppid_model.php */