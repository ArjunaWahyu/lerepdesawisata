...
class peraturan2_model extends CI_Model
{

    public $table = 'peraturan2';
    public $id = 'id';
    public $url = 'url';
    ...
    function get_by_url($id)
    {
        ...
        $this->db->select('peraturan2.id,
                            peraturan2.name,
                            peraturan2.dest,
                            peraturan2.id,
                            peraturan2.published,
                      
                       
                            peraturan2.metatittle,
                            peraturan2.metadest,
                            peraturan2.metakey,
                            peraturan2.create_at,
                            peraturan2.update_at,');
        $this->db->where($this->id, $id);
