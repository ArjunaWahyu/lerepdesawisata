...
class Pariwisata extends CI_Controller {
	    ...
	    {	    	
         ...
         public function page($offset=0, $year = null, $month = null, $day = null){
            ...
            $row = $this->navigations_model->get_by_name('Pariwisata');            

            $jml = $this->contents_model->get_by_all_type('Y', 1);
            
            $config['base_url'] = base_url().'pariwisata/page/';
            ...
            $data['data'] = $this->contents_model->get_by_list('Y',$config['per_page'], $offset, '1');
...
/* End of file Pariwisata.php */
/* Location: ./application/controllers/Pariwisata.php */