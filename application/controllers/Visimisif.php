...
class visimisif extends CI_Controller {
        ...
        public function index()
         ...
         public function page($offset=0, $year = null, $month = null, $day = null){
            ...
            $row = $this->visimisi_model->get_by_name('1');            

            $jml = $this->visimisi_model->get_by_all_type('Y', 2);
            ...
            // $data['data'] = $this->visimisi_model->get_by_list('Y',$config['per_page'], $offset, '2');
        ...
        public function read($url=null, $year = null, $month = null, $day = null){
            $row                = $this->visimisi_model->get_by_url($url);
            $contents           = $this->visimisi_model->get_by_related('Y',4,0,$row->type);
            $setting = $this->setting_model->get_by_published('Y');
            ...
            $update = array(
                 ...
                 $this->visimisi_model->update($row->id, $update);
