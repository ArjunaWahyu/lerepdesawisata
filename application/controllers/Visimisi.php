...
class Visimisi extends CI_Controller {
        ...
        public function index(){
            ...
            $visimisi = $this->visimisi_model->get_all();
            $data = array(
                'visimisi_data' => $visimisi,
                'title'=> 'visimisi Data',
                'header' => 'backend/header',
                'contents' => 'backend/visimisi/visimisi_list',
        ...
        {
            $row = $this->visimisi_model->get_by_id($id);
            if ($row) {
                $data = array(
            'id' => $row->id,
            'name' => $row->name,
            ...
            'update_at' => $row->update_at,
                ...
                $this->load->view('visimisi_read', $data);
            } else {
                $this->session->set_flashdata('message', 'Record Not Found');
                redirect(site_url('visimisi'));
            }
        }
        ...
        //     $data = array(
        //         'button' => 'Create',
        //         'action' => site_url('visimisi/create_action'),
        //     'id' => set_value('id'),
        //     'name' => set_value('name'),
        //     'dest' => set_value('dest'),
        ...
        //     'title'=> 'visimisi Data',
        //     'header' => 'backend/header',
        //     'contents' => 'backend/visimisi/visimisi_form',
        //     'footer' => 'backend/footer'
        // );
        //     $this->load->view('backend/Home', $data);
        // }
        ...
        public function update($id) 
        {
            ...
            if ($row) {
                $data = array(
                    'button' => 'Update',
                    'action' => site_url('visimisi/update_action'),
        ...
        public function update_action() 
        {
            ...
            'update_at' => date("Y-m-d H:i:s"),
                ...
                $this->visimisi_model->update($this->input->post('id', TRUE), $data);
