...
class Apbdesb extends CI_Controller
{
    public function __construct()
    {
        parent::__construct();
        $this->load->Model('Auth_model');
        $this->load->model('Apbdesb_model');
    ...
    public function index()
    {
        ...
        $Apbdesb = $this->Apbdesb_model->get_all();
        $data = array(
            'Apbdesb_data' => $Apbdesb,
            'title' => 'Apbdesb Data',
            'header' => 'backend/header',
            'contents' => 'backend/Apbdesb/Apbdesb_list',
    ...
    {
        $row = $this->Apbdesb_model->get_by_id($id);
        if ($row) {
            $data = array(
                'id' => $row->id,
                'name' => $row->name,
            ...
            $this->load->view('Apbdesb_read', $data);
        } else {
            $this->session->set_flashdata('message', 'Record Not Found');
            redirect(site_url('Apbdesb'));
        }
    }
    ...
    //     $data = array(
    //         'button' => 'Create',
    //         'action' => site_url('Apbdesb/create_action'),
    //     'id' => set_value('id'),
    //     'name' => set_value('name'),
    //     'dest' => set_value('dest'),
    ...
    //     'title'=> 'Apbdesb Data',
    //     'header' => 'backend/header',
    //     'contents' => 'backend/Apbdesb/Apbdesb_form',
    //     'footer' => 'backend/footer'
    // );
    //     $this->load->view('backend/Home', $data);
    // }
    ...
    //         $this->Apbdesb_model->insert($data);
    ...
    public function update($id)
    {
        ...
        if ($row) {
            $data = array(
                'button' => 'Update',
                'action' => site_url('Apbdesb/update_action'),
    ...
    public function update_action()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->Apbdesb_model->update($this->input->post('id', TRUE), $data);
...
/* End of file Apbdesb.php */
/* Location: ./application/controllers/Apbdesb.php */
