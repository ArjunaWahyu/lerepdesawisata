...
class Budaya extends CI_Controller {
	    ...
	    {	    	
         ...
         public function page($offset=0 , $year = null, $month = null, $day = null){
            ...
            $row = $this->navigations_model->get_by_name('Budaya');            

            $jml = $this->contents_model->get_by_all_type('Y', 2);
            
            $config['base_url'] = base_url().'budaya/page/';
            ...
            $data['data'] = $this->contents_model->get_by_list('Y',$config['per_page'], $offset, '2');
...
/* End of file Budaya.php */
/* Location: ./application/controllers/Budaya.php */