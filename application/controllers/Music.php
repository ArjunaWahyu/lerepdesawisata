...
class Music extends CI_Controller {
	    ...
	    {	    	
         ...
         public function page($offset=0, $year = null, $month = null, $day = null){
            ...
            $row = $this->navigations_model->get_by_name('Music');            

            $jml = $this->categorymedia_model->get_by_all_type('Y', 3);
            
            $config['base_url'] = base_url().'music/page/';
            ...
            $data['data'] = $this->categorymedia_model->get_by_list('Y',$config['per_page'], $offset, '3');
            ...
            $this->load->view('frontend/blog_musics',$data);
        ...
        public function read($url=null, $year = null, $month = null, $day = null){
            ...
            $data['day']   = $day;
            $data['events'] = $cur_event;
            $this->load->view('frontend/single_music',$data);     
        }
