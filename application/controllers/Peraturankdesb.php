...
class Peraturankdesb extends CI_Controller {
        ...
        public function index(){
            ...
            $peraturan = $this->peraturan_model->get_all();
            $data = array(
                'peraturan_data' => $peraturan,
                'title'=> 'peraturan ',
                'header' => 'backend/header',
                'contents' => 'backend/peraturan/peraturan_list',
        ...
        public function read($id) 
        {
            ...
            'update_at' => $row->update_at,
                ...
                $this->load->view('peraturan_read', $data);
            } else {
                $this->session->set_flashdata('message', 'Record Not Found');
                redirect(site_url('peraturan'));
            }
        }
        ...
        public function create() 
        {
            $data = array(
                'button' => 'Create',
                'action' => site_url('peraturankdesb/create_action'),
            'id' => set_value('id'),
            'name' => set_value('name'),
            'dest' => set_value('dest'),
            ...
            'title'=> 'peraturan Data',
            'header' => 'backend/header',
            'contents' => 'backend/peraturan/peraturan_form',
            'footer' => 'backend/footer'
        );
            $this->load->view('backend/Home', $data);
        }
        ...
        public function create_action() 
        {
            ...
            'update_at' => date("Y-m-d H:i:s"),
                ...
                redirect(site_url('Peraturankdesb'));
           }
        }
        ...
        public function update($id) 
        {
            ...
            if ($row) {
                $data = array(
                    'button' => 'Update',
                    'action' => site_url('peraturankdesb/update_action'),
        ...
        public function update_action() 
        {
            ...
            'update_at' => date("Y-m-d H:i:s"),
                ...
                $this->peraturan_model->update($this->input->post('id', TRUE), $data);
