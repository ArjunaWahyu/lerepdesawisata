...
class peta extends CI_Controller {
        ...
        public function index()
         ...
         public function page($offset=0, $year = null, $month = null, $day = null){
            ...
            $row = $this->peta_model->get_by_id('1');            

            // $jml = $this->peta_model->get_by_all_type('Y', 2);
            
            $config['base_url'] = base_url().'peta/page/';
            ...
            // $data['data'] = $this->peta_model->get_by_list('Y',$config['per_page'], $offset, '2');
        ...
        public function read($url=null, $year = null, $month = null, $day = null){
            $row                = $this->peta_model->get_by_url($url);
            $contents           = $this->peta_model->get_by_related('Y',4,0,$row->type);
            $setting = $this->setting_model->get_by_published('Y');
            ...
            $update = array(
                 ...
                 $this->peta_model->update($row->id, $update);
