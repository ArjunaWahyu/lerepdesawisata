...
class Peraturan2 extends CI_Controller {
        public function __construct() {
            parent::__construct();
            $this->load->Model('Auth_model');            
            $this->load->model('peraturan2_model');
        ...
        public function index(){
            ...
            $peraturan2 = $this->peraturan2_model->get_all();
            $data = array(
                'peraturan2_data' => $peraturan2,
                'title'=> 'Peraturan - Peraturan ',
                'header' => 'backend/header',
                'contents' => 'backend/peraturan2/peraturan2_list',
        ...
        {
            $row = $this->peraturan2_model->get_by_id($id);
            if ($row) {
                $data = array(
            'id' => $row->id,
            'name' => $row->name,
            ...
            'update_at' => $row->update_at,
                ...
                $this->load->view('peraturan2_read', $data);
            } else {
                $this->session->set_flashdata('message', 'Record Not Found');
                redirect(site_url('peraturan2'));
            }
        }
        ...
        public function create() 
        {
            $data = array(
                'button' => 'Create',
                'action' => site_url('peraturan2/create_action'),
            'id' => set_value('id'),
            'name' => set_value('name'),
            'dest' => set_value('dest'),
            ...
            'header' => 'backend/header',
            'contents' => 'backend/peraturan2/peraturan2_form',
            'footer' => 'backend/footer'
        );
            $this->load->view('backend/Home', $data);
        }
        ...
        public function create_action() 
        {
            ...
            'update_at' => date("Y-m-d H:i:s"),
                ...
                $this->peraturan2_model->insert($data);
        ...
        public function update($id) 
        {
            ...
            if ($row) {
                $data = array(
                    'button' => 'Update',
                    'action' => site_url('Peraturan2/update_action'),
            ...
            'footer' => 'backend/footer'
                ...
                $this->session->set_flashdata('message', 'Record Not Found');
                redirect(site_url('Peraturan2kdesb'));
            }
        }
        ...
        public function update_action() 
        {
            ...
            'update_at' => date("Y-m-d H:i:s"),
                ...
                $this->peraturan2_model->update($this->input->post('id', TRUE), $data);
        ...
        public function delete($id) 
        {
            ...
            if ($row) {
                $this->peraturan2_model->delete($id);
