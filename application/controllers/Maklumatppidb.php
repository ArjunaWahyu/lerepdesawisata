...
class maklumatppidb extends CI_Controller {
        public function __construct() {
            parent::__construct();
            $this->load->Model('Auth_model');            
            $this->load->model('maklumat_ppid_model');
        ...
        public function index(){
            ...
            $maklumatppidb = $this->maklumat_ppid_model->get_all();
            $data = array(
                'maklumatppidb_data' => $maklumatppidb,
                'title'=> 'Maklumat Pelayanan PPID',
                'header' => 'backend/header',
                'contents' => 'backend/maklumatppidb/maklumatppidb_list',
        ...
        {
            $row = $this->maklumat_ppid_model->get_by_id($id);
            if ($row) {
                $data = array(
            'id' => $row->id,
            'name' => $row->name,
            ...
            'update_at' => $row->update_at,
                ...
                $this->load->view('maklumatppidb_read', $data);
            } else {
                $this->session->set_flashdata('message', 'Record Not Found');
                redirect(site_url('maklumatppidb'));
            }
        }
        ...
        //     $data = array(
        //         'button' => 'Create',
        //         'action' => site_url('maklumatppidb/create_action'),
        //     'id' => set_value('id'),
        //     'name' => set_value('name'),
        //     'dest' => set_value('dest'),
        ...
        //     'title'=> 'maklumatppidb Data',
        //     'header' => 'backend/header',
        //     'contents' => 'backend/maklumatppidb/maklumatppidb_form',
        //     'footer' => 'backend/footer'
        // );
        //     $this->load->view('backend/home', $data);
        // }
        ...
        //         $this->maklumat_ppid_model->insert($data);
        ...
        public function update($id) 
        {
            ...
            if ($row) {
                $data = array(
                    'button' => 'Update',
                    'action' => site_url('maklumatppidb/update_action'),
        ...
        public function update_action() 
        {
            ...
            'update_at' => date("Y-m-d H:i:s"),
                ...
                $this->maklumat_ppid_model->update($this->input->post('id', TRUE), $data);
        ...
        //     if ($row) {
        //         $this->maklumat_ppid_model->delete($id);
...
/* End of file maklumatppidb.php */
/* Location: ./application/controllers/maklumatppidb.php */
