...
class maklumat_ppid extends CI_Controller {
        ...
        public function index()
         ...
         public function page($offset=0, $year = null, $month = null, $day = null){
            ...
            $row = $this->maklumat_ppid_model->get_by_name('1');            

            $jml = $this->maklumat_ppid_model->get_by_all_type('Y', 2);
            
            $config['base_url'] = base_url().'visimisif/page/';
            ...
            // $data['data'] = $this->maklumat_ppid_model->get_by_list('Y',$config['per_page'], $offset, '2');
            ...
            $this->load->view('frontend/visimisif',$data);

        }

        public function read($url=null, $year = null, $month = null, $day = null){
            $row                = $this->maklumat_ppid_model->get_by_url($url);
            $contents           = $this->maklumat_ppid_model->get_by_related('Y',4,0,$row->type);
            $setting = $this->setting_model->get_by_published('Y');
            ...
            $update = array(
                 ...
                 $this->maklumat_ppid_model->update($row->id, $update);
