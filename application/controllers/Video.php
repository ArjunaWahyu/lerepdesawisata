...
class Video extends CI_Controller {
	    ...
	    {	    	
         ...
         public function page($offset=0, $year = null, $month = null, $day = null){
            ...
            $row = $this->navigations_model->get_by_name('Video');            

            $jml = $this->categorymedia_model->get_by_all_type('Y', 2);
            ...
            $data['datax'] = $this->categorymedia_model->get_by_list('Y',$config['per_page'], $offset, '2');
            ...
            $this->load->view('frontend/blog_videos',$data);
        ...
        public function read($url=null, $year = null, $month = null, $day = null){
            ...
            $data['day']   = $day;
            $data['events'] = $cur_event;
            $this->load->view('frontend/single_video',$data);     
        }
