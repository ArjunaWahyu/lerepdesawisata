...
class peraturankdes extends CI_Controller {
        ...
        public function index()
         ...
         public function page($offset=0, $year = null, $month = null, $day = null){
            ...
            // $row = $this->peraturan_model->get_by_list();            

            $jml = $this->peraturan_model->get_by_all_type('Y', 2);
            ...
            $data['offset'] = $offset;
             ...
             $data['data'] = $this->peraturan_model->get_by_list('Y',$config['per_page'], $offset, '2');
            
            $setting = $this->peraturan_model->get_by_published('Y');
        ...
        public function read($url=null, $year = null, $month = null, $day = null){
            $row                = $this->peraturan_model->get_by_url($url);
            $contents           = $this->peraturan_model->get_by_related('Y',4,0,$row->type);
            ...
            $update = array(
                 ...
                 $this->peraturan_model->update($row->id, $update);
