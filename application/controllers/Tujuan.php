...
class Tujuan extends CI_Controller {
        ...
        public function index(){
            ...
            $tujuan = $this->tujuan_model->get_all();
            $data = array(
                'tujuan_data' => $tujuan,
                'title'=> 'tujuan Data',
                'header' => 'backend/header',
                'contents' => 'backend/tujuan/tujuan_list',
        ...
        {
            $row = $this->tujuan_model->get_by_id($id);
            if ($row) {
                $data = array(
            'id' => $row->id,
            'name' => $row->name,
            ...
            'update_at' => $row->update_at,
                ...
                $this->load->view('tujuan_read', $data);
            } else {
        ...
        //     'title'=> 'tujuan Data',
        //     'header' => 'backend/header',
        //     'contents' => 'backend/tujuan/tujuan_form',
        //     'footer' => 'backend/footer'
        // );
        //     $this->load->view('backend/Home', $data);
        // }
        ...
        public function update_action() 
        {
            ...
            'update_at' => date("Y-m-d H:i:s"),
                ...
                $this->tujuan_model->update($this->input->post('id', TRUE), $data);
