...
class tugas_ppid extends CI_Controller {
        public function __construct() {
            parent::__construct();
            $this->load->Model('Auth_model');            
            $this->load->model('tugas_ppid_model');
        ...
        public function index(){
            ...
            $tugas_ppid = $this->tugas_ppid_model->get_all();
            $data = array(
                'tugas_ppid_data' => $tugas_ppid,
                'title'=> 'Tugas PPID',
                'header' => 'backend/header',
                'contents' => 'backend/tugas_ppid/tugas_ppid_list',
        ...
        {
            $row = $this->tugas_ppid_model->get_by_id($id);
            if ($row) {
                $data = array(
            'id' => $row->id,
            'name' => $row->name,
            ...
            'update_at' => $row->update_at,
                ...
                $this->load->view('tugas_ppid_read', $data);
            } else {
                $this->session->set_flashdata('message', 'Record Not Found');
                redirect(site_url('tugas_ppid'));
            }
        }
        ...
        //     $data = array(
        //         'button' => 'Create',
        //         'action' => site_url('tugas_ppid/create_action'),
        //     'id' => set_value('id'),
        //     'name' => set_value('name'),
        //     'dest' => set_value('dest'),
        ...
        //     'title'=> 'tugas_ppid Data',
        //     'header' => 'backend/header',
        //     'contents' => 'backend/tugas_ppid/tugas_ppid_form',
        //     'footer' => 'backend/footer'
        // );
        //     $this->load->view('backend/home', $data);
        // }
        ...
        //         $this->tugas_ppid_model->insert($data);
        ...
        public function update($id) 
        {
            ...
            if ($row) {
                $data = array(
                    'button' => 'Update',
                    'action' => site_url('tugas_ppid/update_action'),
        ...
        public function update_action() 
        {
            ...
            'update_at' => date("Y-m-d H:i:s"),
                ...
                $this->tugas_ppid_model->update($this->input->post('id', TRUE), $data);
        ...
        //     if ($row) {
        //         $this->tugas_ppid_model->delete($id);
...
/* End of file tugas_ppid.php */
/* Location: ./application/controllers/tugas_ppid.php */
