...
class Rjmdesb extends CI_Controller
{
    public function __construct()
    {
        parent::__construct();
        $this->load->Model('Auth_model');
        $this->load->model('Rjmdesb_model');
    ...
    public function index()
    {
        ...
        $Rjmdesb = $this->Rjmdesb_model->get_all();
        $data = array(
            'Rjmdesb_data' => $Rjmdesb,
            'title' => 'Rjmdes Data',
            'header' => 'backend/header',
            'contents' => 'backend/Rjmdesb/Rjmdesb_list',
    ...
    {
        $row = $this->Rjmdesb_model->get_by_id($id);
        if ($row) {
            $data = array(
                'id' => $row->id,
                'name' => $row->name,
            ...
            $this->load->view('Rjmdesb_read', $data);
        } else {
            $this->session->set_flashdata('message', 'Record Not Found');
            redirect(site_url('Rjmdesb'));
        }
    }
    ...
    //     $data = array(
    //         'button' => 'Create',
    //         'action' => site_url('Rjmdesb/create_action'),
    //     'id' => set_value('id'),
    //     'name' => set_value('name'),
    //     'dest' => set_value('dest'),
    ...
    //     'title'=> 'Rjmdesb Data',
    //     'header' => 'backend/header',
    //     'contents' => 'backend/Rjmdesb/Rjmdesb_form',
    //     'footer' => 'backend/footer'
    // );
    //     $this->load->view('backend/Home', $data);
    // }
    ...
    //         $this->Rjmdesb_model->insert($data);
    ...
    public function update($id)
    {
        ...
        if ($row) {
            $data = array(
                'button' => 'Update',
                'action' => site_url('Rjmdesb/update_action'),
    ...
    public function update_action()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->Rjmdesb_model->update($this->input->post('id', TRUE), $data);
...
/* End of file Rjmdesb.php */
/* Location: ./application/controllers/Rjmdesb.php */
