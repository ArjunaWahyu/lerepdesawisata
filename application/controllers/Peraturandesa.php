...
class peraturandesa extends CI_Controller {
        ...
        public function index()
         ...
         public function page($offset=0, $year = null, $month = null, $day = null){
            ...
            // $row = $this->peraturandesab_model->get_by_list();            

            $jml = $this->peraturandesab_model->get_by_all_type('Y', 2);
            ...
            $data['offset'] = $offset;
             ...
             $data['data'] = $this->peraturandesab_model->get_by_list('Y',$config['per_page'], $offset, '2');
            
            $setting = $this->peraturandesab_model->get_by_published('Y');
            ...
            $this->load->view('frontend/peraturan_desa',$data);

        }

        public function read($url=null, $year = null, $month = null, $day = null){
            $row                = $this->peraturandesab_model->get_by_url($url);
            $contents           = $this->peraturandesab_model->get_by_related('Y',4,0,$row->type);
            ...
            $update = array(
                 ...
                 $this->peraturandesab_model->update($row->id, $update);
