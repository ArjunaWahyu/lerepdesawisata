...
class Navigations extends CI_Controller{
    ...
    public function index(){
            ...
            $contents = $this->navigations_model->get_all();
            $data = array(
                'record' => $contents,
                'title'=> 'Navigations Data',
                'header' => 'backend/header',
                'contents' => 'backend/navigations/navigations_list',
    ...
    public function create() 
        {
            $data = array(
                'button' => 'Create',
                'action' => site_url('navigations/create_action'),
            'id' => set_value('id'),
            'name' => set_value('name'),
            'icon' => set_value('icon'),
            'link' => set_value('link'),
            ...
            'title'=> 'Navigations Data',
            'header' => 'backend/header',
            'contents' => 'backend/navigations/navigations_form',
            'footer' => 'backend/footer'
        );
            $this->load->view('backend/Home', $data);
        }
        ...
        public function update($id) 
        {
            ...
            if ($row) {
                $data = array(
                    'button' => 'Update',
                    'action' => site_url('navigations/update_action'),
